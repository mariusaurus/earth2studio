...
#
# This notebook demonstrates how to visualize tropical cyclone (TC) tracks
...
if region == "global":
    ...
    raise ValueError(
        f"region {region} not yet implemented. "
        "Feel free to add it by providing lat/lon coords of the bounding box"
    )
